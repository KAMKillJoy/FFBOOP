...
vp9 = Codec(
    ...
    params={
        ...
        "scale": None,  # обрабатывается уникальным методом. Значение параметра не имеет значения.
        "fps": None,  # обрабатывается уникальным методом. Значение параметра не имеет значения.
